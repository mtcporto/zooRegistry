...
export const db: Db = {
  ...
  animais: [
    { id: '301', f_classeId: classeMamiferosId, f_ordemId: ordemPrimatasId, f_familiaId: familiaCebidaeId, f_nomecientifico: 'Sapajus flavius', f_nome: 'Macaco-prego-galego', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "blonde capuchin", f_status_conservacao: 'Em Perigo (EN)' },
    
    // Novos animais
    { id: generateId(), f_classeId: classeMamiferosId, f_ordemId: ordemCarnivoraId, f_familiaId: familiaFelidaeId, f_nomecientifico: 'Panthera leo', f_nome: 'Leão', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "lion pride", f_status_conservacao: 'Vulnerável (VU)' }, // 520
    { id: generateId(), f_classeId: classeMamiferosId, f_ordemId: ordemCarnivoraId, f_familiaId: familiaFelidaeId, f_nomecientifico: 'Panthera onca', f_nome: 'Onça-pintada', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "jaguar spots", f_status_conservacao: 'Quase Ameaçado (NT)' }, // 521
    { id: generateId(), f_classeId: classeMamiferosId, f_ordemId: ordemCarnivoraId, f_familiaId: familiaFelidaeId, f_nomecientifico: 'Puma concolor', f_nome: 'Onça-parda', f_nomes_alternativos: 'Suçuarana, Leão-baio', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "puma concolor", f_status_conservacao: 'Pouco Preocupante (LC)' }, // 522
    { id: generateId(), f_classeId: classeReptiliaId, f_ordemId: ordemCrocodyliaId, f_familiaId: familiaAlligatoridaeId, f_nomecientifico: 'Caiman latirostris', f_nome: 'Jacaré-de-papo-amarelo', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "caiman snout", f_status_conservacao: 'Pouco Preocupante (LC)' }, // 523
    { id: generateId(), f_classeId: classeAvesId, f_ordemId: ordemPsittaciformesId, f_familiaId: familiaPsittacidaeId, f_nomecientifico: 'Anodorhynchus hyacinthinus', f_nome: 'Arara-azul-grande', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "hyacinth macaw", f_status_conservacao: 'Vulnerável (VU)' }, // 524
    { id: generateId(), f_classeId: classeMamiferosId, f_ordemId: ordemPrimatasId, f_familiaId: familiaCallitrichidaeId, f_nomecientifico: 'Callithrix jacchus', f_nome: 'Sagui-de-tufos-brancos', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "common marmoset", f_status_conservacao: 'Pouco Preocupante (LC)' }, // 525
    { id: generateId(), f_classeId: classeMamiferosId, f_ordemId: ordemCarnivoraId, f_familiaId: familiaFelidaeId, f_nomecientifico: 'Leopardus tigrinus', f_nome: 'Gato-do-mato-pequeno', f_nomes_alternativos: 'Oncilla', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "oncilla cat", f_status_conservacao: 'Vulnerável (VU)' }, // 526
    { id: generateId(), f_classeId: classeMamiferosId, f_ordemId: ordemPilosaId, f_familiaId: familiaMyrmecophagidaeId, f_nomecientifico: 'Myrmecophaga tridactyla', f_nome: 'Tamanduá-bandeira', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "giant anteater", f_status_conservacao: 'Vulnerável (VU)' }, // 527
    { id: generateId(), f_classeId: classeMamiferosId, f_ordemId: ordemPilosaId, f_familiaId: familiaMyrmecophagidaeId, f_nomecientifico: 'Tamandua tetradactyla', f_nome: 'Tamanduá-mirim', f_nomes_alternativos: 'Mambira, Coleteiro', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "southern tamandua", f_status_conservacao: 'Pouco Preocupante (LC)' }, // 528
    { id: generateId(), f_classeId: classeReptiliaId, f_ordemId: ordemSquamataId, f_familiaId: familiaColubridaeId, f_nomecientifico: 'Pantherophis guttatus', f_nome: 'Cobra-do-milho', f_nomes_alternativos: 'Corn Snake', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "corn snake", f_status_conservacao: 'Pouco Preocupante (LC) (Não nativa)' }, // 529
    { id: generateId(), f_classeId: classeReptiliaId, f_ordemId: ordemSquamataId, f_familiaId: familiaPythonidaeId, f_nomecientifico: 'Python regius', f_nome: 'Píton-real', f_nomes_alternativos: 'Ball Python', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "ball python", f_status_conservacao: 'Quase Ameaçado (NT) (Não nativa)' }, // 530
    { id: generateId(), f_classeId: classeReptiliaId, f_ordemId: ordemSquamataId, f_familiaId: familiaViperidaeId, f_nomecientifico: 'Crotalus durissus', f_nome: 'Cascavel', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "rattlesnake rattle", f_status_conservacao: 'Pouco Preocupante (LC)' }, // 531
    { id: generateId(), f_classeId: classeAvesId, f_ordemId: ordemCathartiformesId, f_familiaId: familiaCathartidaeId, f_nomecientifico: 'Coragyps atratus', f_nome: 'Urubu-de-cabeça-preta', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "black vulture", f_status_conservacao: 'Pouco Preocupante (LC)' }, // 532
    { id: generateId(), f_classeId: classeAvesId, f_ordemId: ordemFalconiformesId, f_familiaId: familiaFalconidaeId, f_nomecientifico: 'Caracara plancus', f_nome: 'Carcará', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "southern caracara", f_status_conservacao: 'Pouco Preocupante (LC)' }, // 533
    { id: generateId(), f_classeId: classeMamiferosId, f_ordemId: ordemPrimatasId, f_familiaId: familiaCercopithecidaeId, f_nomecientifico: 'Macaca mulatta', f_nome: 'Macaco rhesus', f_imagem: 'https://placehold.co/300x200.png', "data-ai-hint": "rhesus macaque", f_status_conservacao: 'Pouco Preocupante (LC) (Não nativo)' }, // 534
  ],
  cadastros: [
    { 
      id: '401', 
      f_animalId: '301', // Macaco-prego-galego
      f_apelido: 'Galego', 
      f_registro: 'BICA-001', 
    ...
    { 
      id: generateId(), // 535
      f_animalId: db.animais.find(a => a.f_nome === 'Leão')!.id, // Leão (520)
      f_apelido: 'Simba', 
      f_registro: 'BICA-002', 
    ...
    { 
      id: generateId(), // 536
      f_animalId: db.animais.find(a => a.f_nome === 'Onça-pintada')!.id, // Onça-pintada (521)
      f_apelido: 'Juma', 
      f_registro: 'BICA-003', 
    ...
    { 
      id: generateId(), // 537
      f_animalId: db.animais.find(a => a.f_nome === 'Arara-azul-grande')!.id, // Arara-azul-grande (524)
      f_apelido: 'Blue', 
      f_registro: 'BICA-004', 
     ...
     { 
      id: generateId(), // 538
      f_animalId: db.animais.find(a => a.f_nome === 'Jacaré-de-papo-amarelo')!.id, // Jacaré-de-papo-amarelo (523)
      f_apelido: 'Papo', 
      f_registro: 'BICA-005', 
    ...
    { 
      id: generateId(), // 539
      f_animalId: db.animais.find(a => a.f_nome === 'Sagui-de-tufos-brancos')!.id, // Sagui-de-tufos-brancos (525)
      f_apelido: 'Tufinho', 
      f_registro: 'BICA-006', 
    ...
    { 
      id: generateId(), // 540
      f_animalId: db.animais.find(a => a.f_nome === 'Tamanduá-bandeira')!.id, // Tamanduá-bandeira (527)
      f_apelido: 'Bandeira', 
      f_registro: 'BICA-007', 
    ...
    { 
      id: generateId(), // 541
      f_animalId: db.animais.find(a => a.f_nome === 'Cobra-do-milho')!.id, // Cobra-do-milho (529)
      f_apelido: 'Milly', 
      f_registro: 'BICA-008', 
...
// Re-map names after all IDs are generated and objects created
